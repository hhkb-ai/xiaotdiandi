  ...
  <nav class="category-bar container" aria-label="顶部分类" @click="closeGroups($event)">
    ...
    <div class="category-group category-group-campus" :class="{ 'is-open': openGroup === 'campus' }">
      ...
      <div class="category-panel" aria-label="校园日常细分">
        ...
        <router-link to="/" @click="applyCategory('活动与关系')">
          <span>活动与关系</span>
          <small>社团、运动会、同学相处</small>
        </router-link>
        <router-link to="/" @click="applyCategory('毕业与回忆')">
          <span>毕业与回忆</span>
    ...
    <div class="category-group category-group-study" :class="{ 'is-open': openGroup === 'study' }">
      ...
      <div class="category-panel" aria-label="学习知识细分">
        ...
        <router-link to="/" @click="applyCategory('实用知识')">
          <span>实用知识</span>
          <small>四六级、学生优惠、省钱攻略</small>
        </router-link>
        <router-link to="/" @click="applyCategory('求职复盘')">
          <span>求职复盘</span>
          <small>实习、校招、Offer 和工作选择</small>
        </router-link>
        <router-link to="/" @click="applyCategory('网络梗知识')">
          <span>网络梗知识</span>
